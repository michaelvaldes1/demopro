...
interface UnblockSlotModalProps {
    isOpen: boolean;
...
export default function UnblockSlotModal({
    isOpen,
    onOpenChange,
    onConfirm,
    slotTime,
    isLoading
}: UnblockSlotModalProps) {
                    ...
                    <div className="relative">
                        ...
                        <ModalHeader className="flex flex-col gap-3 items-center justify-center pt-10 pb-4">
                            ...
                            <div className="text-center px-4">
                                <h2 className="text-xl font-bold text-white tracking-tight">Desbloquear Horario</h2>
                        ...
                        <ModalBody className="px-7 py-2 text-center">
                            <p className="text-sm text-white/50 leading-relaxed">
                                ¿Estás seguro de que deseas desbloquear este horario? Los clientes <span className="text-white/80 font-semibold">podrán volver a agendar</span> citas en esta hora.
                            </p>
                        </ModalBody>
