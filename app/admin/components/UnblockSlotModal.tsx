                    ...
                    <div className="relative">
                        ...
                        <ModalHeader className="flex flex-col gap-2 items-center justify-center pt-8 pb-6 border-b border-white/5 bg-white/[0.02]">
                            ...
                            <div className="text-center">
                                <h2 className="text-lg font-black text-white uppercase tracking-tight">Desbloquear Horario</h2>
                        ...
                        <ModalBody className="p-6 text-center">
                            <p className="text-sm text-zinc-400">
                                ¿Estás seguro de que deseas desbloquear este horario? Los clientes podrán volver a agendar citas.
                            </p>
                        </ModalBody>
