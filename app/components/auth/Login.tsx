                ...
                <Card className="w-full max-w-md p-6 border-zinc-800 shadow-2xl" style={{
                    ...
                    <CardBody className="flex flex-col gap-4">
                        <Button
                            ...
                            className="h-12 font-medium text-white border-[#D09E1E] hover:bg-[#D09E1E]/10 flex items-center justify-center gap-3"
                        >
                            <span className="flex items-center">Continuar con Google</span>
                        </Button>
